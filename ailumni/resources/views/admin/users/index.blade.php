...
@section('content')
    ...
    <div>
        <div class="max-w-50rem mx-auto py-10 sm:px-6 lg:px-8" >
            <div class="">
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" width="450"class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        Email
                                    </th>
